...
% https://stackoverflow.com/a/7856991
...
xthresh = 0.1;
%txt = [txt{:}]  % https://uk.mathworks.com/matlabcentral/answers/506916-cell2mat-does-not-support-cell-arrays-containing-cell-arrays-or-objects#answer_416990
n = length(x);
